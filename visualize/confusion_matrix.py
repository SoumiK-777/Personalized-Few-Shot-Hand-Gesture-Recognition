...
def main():
 ...
 cm=confusion_matrix(truth,pred,labels=range(7),normalize="true");sns.heatmap(cm,xticklabels=GESTURES,yticklabels=GESTURES,annot=True,fmt=".2f",cmap="Blues");plt.savefig(output,dpi=300,bbox_inches="tight");plt.close()
